...
RUN wget "https://github.com/concourse/concourse/releases/download/v5.3.0/fly-5.8.0-linux-amd64.tgz" && tar xzvf fly-5.8.0-linux-amd64.tgz && mv fly /usr/local/bin/fly && rm -r fly-5.3.0-linux-amd64.tgz
